...
//   cout << "Apontador size:" << sizeof(Apontador) << endl;
//   cout << "list size: "<< sizeof(TipoLista)  << endl;
//   cout << "var lista " << lista << endl;
//   return lista;
// }
...
//     Apontador p = (Apontador) malloc(sizeof(Celula));
//     cout << "cel size: "<< sizeof(Celula)  << endl;
//     for (p = Lista->Primeiro->Prox; p != NULL; p = p->Prox) {
// 		  cout << p << " " << p->Item.Chave << " " << p->Prox << endl;
// 	  }
//     cout << endl;
//   }
// }
